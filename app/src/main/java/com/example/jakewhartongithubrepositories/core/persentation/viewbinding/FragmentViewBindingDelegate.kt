package com.example.jakewhartongithubrepositories.core.persentation.viewbinding
...
/**
 * fragment binding to create the binding object and observe for
 * the lifecycle owner to add and remove the observer that create the object
 *
 *
 *               -------- -------- references -------- ----------
